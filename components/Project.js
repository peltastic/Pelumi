...
function Project({image, name, desc}) {
  return (
    <div className={` h-72 w30 bg-zinc-800 text-white relative mx-8 mb-12 rounded-xl ${classes.project}`}>
        {image ? <img src={image} alt="" className="h-1/2 m-auto" /> : 
