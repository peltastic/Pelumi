...
const AboutCards = (props: Props) => {
  return (
    <div className={` ${props.borderStyle === "top" ? "border-l border-b" : "border-t border-r"} lg:h-[25rem] px-6  xs:px-10 py-10 text-left gap-y-4  rounded-xl  border-[#262626] shadow-[0_4px_12px_rgba(0,0,0,0.25)] `}>
